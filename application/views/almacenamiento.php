...
<body>
 ...
 <br>
	...
	<div class="container">
		<div class="row">
			<?php foreach ($almacena as $valor): ?>
				<div class="col-md-4">
					<form action="<?php echo base_url(); ?>Carrito/agregarCarrito" method="post">
						<div class="card" style="width: 20rem;">

							<img class="card-img-top tagImg" src="<?php echo base_url().'assets/images/'.$valor->NOMBRE_IMAGEN; ?>" alt="Card image cap" style="width: 275px;height: 275px">
							<div class="card-body">
