...
<div class="row">
    <div style="left: 190px;" class="col-md-6">
        <form  action="<?php echo base_url(); ?>Proveedores/ActualizarProv" method="post">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="<?=$prov->NOMBRE_PROVEEDOR ?>" type="text" name="NOMBRE_PROVEEDOR"/>
                    </div>
